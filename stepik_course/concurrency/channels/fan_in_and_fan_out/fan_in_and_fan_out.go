...
func main() {
	...
	// this can be done by calling `getSquareChan` function multiple times where individual function call
	// returns a channel which sends square of numbers provided by `chanInputNums` channel
